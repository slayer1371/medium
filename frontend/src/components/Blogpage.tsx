                ...
                <div className="max-w-screen-xl grid grid-cols-1 md:grid-cols-12 gap-8 px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="md:col-span-8">
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                            Posted on April 1, 2025 by <span className="font-semibold">{blog.author.name || "Anonymous"}</span>
                        </p>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        {/* Placeholder for author's bio or description */}
                                        A passionate writer who loves to share insights on various topics.
                                    </p>
                                </div>
                            </div>
